...
const Item = ({ route, navigation }) => {
  ...
  function editOrder(action, menuId, price) {
    ...
    let item = orderList.filter((a) => a._id == menuId);
  ...
  function getOrderQty(menuId) {
    let orderItem = orderItems.filter((a) => a._id == menuId);
  ...
  function renderItemInfo() {
    return (
      ...
      >
        <View>
          <View key={product._id} style={{ alignItems: "center" }}>
            ...
            >
              ...
              >
                {product.product_name} - {product.unitprice.toFixed(2)}
              </Text>
          ...
          {menuItems.map((item, index) => {
            if (item._id !== product._id) {
              console.log("awaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
              ...
              <View key={item._id} style={{ alignItems: "center" }}>
                ...
                >
                  ...
                  >
                    {product.product_name} - {item.unitprice.toFixed(2)}
                  </Text>
