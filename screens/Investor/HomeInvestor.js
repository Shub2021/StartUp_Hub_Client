      ...
      <Card style={styles.comDetails} kety={item.id}>
        <View style={styles.allCards}>
          <Image
            ...
            source={{
              uri: "https://images.unsplash.com/flagged/photo-1570612861542-284f4c12e75f?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80",
            }}
          />
          <View>
