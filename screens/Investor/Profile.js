...
const Profile = (props) => {
    ...
    return(
          <View style = {styles.container}>
            <Image 
                source={{uri:'https://image.freepik.com/free-vector/brainstorming-illustration_65141-415.jpg'}}
                style = {{height: '20%'}}
            />
            <View style={{alignItems:'center', marginTop:-50}}>
                <Image 
                    style = {{width:140, height:140, borderRadius:70}}
                    source={{uri:'https://image.freepik.com/free-photo/caucasian-handsome-man-posing-with-arms-hip-smiling-isolated-purple-wall_1368-89876.jpg'}}
                />
            </View>
            <View style={{alignItems:'center'}}>
                <View style={{flexDirection:'row'}}>
                    <Title style={{marginTop:10, alignItems:'center', marginLeft:15}}>Ravindu Perera</Title>
                    <MaterialIcons style={{marginTop:7, marginLeft:5}}
                    name="verified" size={15} color="#0396FF" />
                </View>
            ...
            <Card style={styles.profileCard}>
                <View style={styles.cardIcon}>
                    ...
                    name="call-outline" size={25} color="black" />
            ...
            <Card style={styles.profileCard}>
                <View style={styles.cardIcon}>
                    <Fontisto style={{marginTop:5}}
                    name="email" size={25} color="black" />
                    <View style={{marginLeft:20}}>
            ...
            <Card style={styles.profileCard}>
                <View style={styles.cardIcon}>
                    <MaterialCommunityIcons style={{marginTop:5}}
                    name="finance" size={25} color="black" />
                    <View style={{marginLeft:20}}>
            ...
            >
                <View style={styles.cardIcon}>
                    ...
                    <Badge style={{marginLeft:10, backgroundColor:'#7367F0', fontSize:12, fontWeight:'bold'}}>5</Badge>
                </View>
            </Card>
            
            <Button 
                    onPress={()=>props.navigation.navigate('CreateInvestment')}
                    // style={{ width:300, padding: 3, marginTop:150}}
                    color='#0396FF'
